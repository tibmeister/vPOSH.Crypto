...
<#
    ...
    .DESCRIPTION
        Generate a random password with some advanced functionality
    .EXAMPLE
        Get-RandomPassword.ps1 -ExcludedCharacters '@','I','l','!' -MinimumLength 10 -MaximumLength 42
    ...
    .EXAMPLE
        Get-RandomPassword.ps1 -ExcludedCharacters '@','I','l','!','_','`' -NonDuplicating
